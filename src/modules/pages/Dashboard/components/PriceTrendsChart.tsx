...
export default function PriceTrendsChart() {
  return (
    <Col className="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/5 overflow-hidden">
      {/* Header */}
      <Col className="p-6 border-b border-outline-variant/10">
        <Row className="flex-col md:flex-row md:items-center justify-between gap-4">
          <Col>
          ...
          {/* Company Selector */}
          <Col className="gap-1 min-w-[12.5rem]">
      ...
      {/* Chart Area */}
      <Col className="p-8 flex-1 justify-end min-h-[30rem] relative">
        {/* Grid Lines */}
        <Box className="absolute inset-0 p-8 opacity-20">
        ...
        {/* SVG Chart */}
        <svg className="w-full h-80 overflow-visible" preserveAspectRatio="none" viewBox="0 0 1000 200">
          {/* Signal (Main) */}
        ...
        <Row className="justify-between mt-10 text-[0.625rem] font-bold text-on-surface-variant/60 tracking-widest uppercase">
