...
export default function PriceTrendsChart() {
  return (
    <Col className="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/5 overflow-hidden">
      ...
      <Col className="p-4 md:p-6 border-b border-outline-variant/10">
        <Row className="flex-col sm:flex-row sm:items-center justify-between gap-4">
          <Col className="shrink-0">
            ...
            <TextPrimary text="Historical pricing volatility for SUV Category (30D)" className="text-[0.6875rem] md:text-xs text-on-surface-variant" />
          </Col>
          {/* Company Selector */}
        ...
        {/* Legend */}
        <Row className="flex-wrap gap-1.5 md:gap-2 mt-3 md:mt-4">
          <Row className="items-center gap-1.5 px-2 md:px-3 py-1 rounded-full bg-primary/5 text-[0.5625rem] md:text-[0.625rem] font-bold text-primary border border-primary/10">
            <Box className="w-2 h-2 rounded-full bg-primary" />
            <TextPrimary text="Signal" className="" />
          </Row>
          <Row className="items-center gap-1.5 px-2 md:px-3 py-1 rounded-full bg-surface-container-low text-[0.5625rem] md:text-[0.625rem] font-bold text-on-surface-variant border border-outline-variant/20">
          ...
          <BaseButton variant="bordered" size="sm" className="rounded-full border-dashed border-outline-variant/40 text-[0.5625rem] md:text-[0.625rem] font-bold text-on-surface-variant px-2 md:px-3 py-1">
      ...
      {/* Chart Area */}
      <Col className="p-4 md:p-6 lg:p-8 flex-1 justify-end min-h-[16rem] sm:min-h-[20rem] md:min-h-[24rem] lg:min-h-[30rem] relative">
        {/* Grid Lines */}
        <Box className="absolute inset-0 p-4 md:p-6 lg:p-8 opacity-20">
        ...
        {/* SVG Chart */}
        <svg className="w-full h-44 sm:h-56 md:h-64 lg:h-80 overflow-visible" preserveAspectRatio="none" viewBox="0 0 1000 200">
        ...
        <Row className="justify-between mt-4 md:mt-6 lg:mt-10 text-[0.5rem] md:text-[0.625rem] font-bold text-on-surface-variant/60 tracking-widest uppercase">
          <TextPrimary text="Oct 12" className="" />
          <TextPrimary text="Oct 19" className="hidden sm:block" />
          <TextPrimary text="Oct 26" className="" />
          <TextPrimary text="Nov 02" className="hidden sm:block" />
          <TextPrimary text="Nov 09" className="hidden md:block" />
